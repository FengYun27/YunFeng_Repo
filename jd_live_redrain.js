/**
 * 超级直播间红包雨
 * cron "0,30 0-23/1 * * *" live_redrain.js,tag=超级直播间红包雨
 * 
 * by:Orz-3
 */
const $ = new Env('超级直播间红包雨');
let allMessage = '', id = 'o5fIwMSoKWLZ7mkK';
...
!(async () => {
    ...
    if (!($.st <= nowTs && nowTs < $.ed)) {
        ...
        $.http.get({ url: `https://purge.jsdelivr.net/gh/gitupdate/updateTeam@master/redrain.json` }).then((resp) => { console.log(resp.body) }).catch((e) => $.log('刷新CDN异常', e));
